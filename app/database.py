...
def save_market_snapshot(ticker: str, title: str, close_time: str,
                         ...
                         kraken_price: float = None):
    now = datetime.utcnow().isoformat()
    query = """
        INSERT INTO market_snapshots
          (ticker, title, scanned_at, close_time, yes_ask, yes_bid,
           no_ask, no_bid, btc_price, brti_price, kraken_price, time_to_close_secs, strike_str,
           volume, open_interest)
        VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
    """
    params = (ticker, title, now, close_time, yes_ask, yes_bid, no_ask, no_bid,
              btc_price, brti_price, kraken_price, time_to_close_secs, strike_str, volume, open_interest)
